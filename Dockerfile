...
RUN mkdir -p /opt/whisper/bin /opt/whisper/models \
    ...
    && test -x /opt/whisper/bin/whisper-cli \
...
RUN test -x /opt/whisper/bin/whisper-cli \
    && /opt/whisper/bin/whisper-cli --help >/dev/null \
